...
{
    public class MircatInterstitial : IAdAdapter
    {
        ...
        public bool Show(bool time)
        {
            ...
            try
            {
                ...
                _adservice.TrackingService.Event("Ad", "Interstitial_Show");
        ...
        private void OnSkipped()
        {
            ...
            _adservice.TrackingService.Event("Ad", "Interstitial_Skipped");
            _adservice.CurrentRewardAmount = 0;
            _isLoaded = false;
        ...
        {
            Log("Failed");
            _adservice.TrackingService.Event("Ad", "Interstitial_Fail");
            _adservice.CurrentRewardAmount = 0;
            _isLoaded = false;
            _adservice.Close(_zone);
        }
        ...
        {
            Log("Rewarded");
            _adservice.TrackingService.Event("Ad", "Interstitial_Success");
            _adservice.CurrentRewardAmount = 0;
            _isLoaded = false;
            _adservice.Close(_zone);
        }
        ...
        private void Log(string message)
        {
            if (_adservice.DebugMode)
                Debug.LogWarning("MircatInterstitial > " + message);
        }
