...
namespace Standard_Assets.Core.BestHTTP.SocketIO.Transports
{
    /// <summary>
    ...
    internal sealed class WebSocketTransport : ITransport
    {
        ...
        public WebSocket.WebSocket Implementation { get; private set; }
        ...
        public void Open()
        {
            ...
            Implementation = new WebSocket.WebSocket(uri);
        ...
        /// </summary>
        private void OnMessage(WebSocket.WebSocket ws, string message)
        {
            if (ws != Implementation)
                return;
        ...
        /// </summary>
        private void OnBinary(WebSocket.WebSocket ws, byte[] data)
        {
            if (ws != Implementation)
                return;
        ...
        /// </summary>
        private void OnError(WebSocket.WebSocket ws, Exception ex)
        {
            if (ws != Implementation)
                return;
        ...
        /// </summary>
        private void OnClosed(WebSocket.WebSocket ws, ushort code, string message)
        {
            if (ws != Implementation)
              return;
