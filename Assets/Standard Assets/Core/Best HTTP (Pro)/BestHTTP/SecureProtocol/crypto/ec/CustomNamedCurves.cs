...
using Standard_Assets.Core.BestHTTP.SecureProtocol.math.ec.custom.djb;
using Standard_Assets.Core.BestHTTP.SecureProtocol.math.ec.custom.sec;
...
namespace Standard_Assets.Core.BestHTTP.SecureProtocol.crypto.ec
{
