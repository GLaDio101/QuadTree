...
using Standard_Assets.Core.BestHTTP.PlatformSupport.Collections.ObjectModel;
using Standard_Assets.Core.BestHTTP.PlatformSupport.Collections.Specialized;
using Standard_Assets.Core.BestHTTP.SignalR.Authentication;
using Standard_Assets.Core.BestHTTP.SignalR.Hubs;
using Standard_Assets.Core.BestHTTP.SignalR.JsonEncoders;
using Standard_Assets.Core.BestHTTP.SignalR.Messages;
using Standard_Assets.Core.BestHTTP.SignalR.Transports;
#if !NETFX_CORE
...
namespace Standard_Assets.Core.BestHTTP.SignalR
{
