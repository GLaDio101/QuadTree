...
using Standard_Assets.Core.BestHTTP;
using Standard_Assets.Core.BestHTTP.Statistics;
using Standard_Assets.Core.Examples.Helpers;
using Standard_Assets.Core.Examples.HTTP;
using Standard_Assets.Core.Examples.Plugin;
using Standard_Assets.Core.Examples.SignalR;
using Standard_Assets.Core.Examples.SocketIO;
using Standard_Assets.Core.Examples.Websocket;
using UnityEngine;

namespace Standard_Assets.Core.Examples
{
    /// <summary>
