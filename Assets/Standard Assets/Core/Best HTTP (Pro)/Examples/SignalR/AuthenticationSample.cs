...
using Standard_Assets.Core.BestHTTP.SignalR;
...
using Standard_Assets.Core.Examples.SignalR.Authentication_Providers;
using UnityEngine;

namespace Standard_Assets.Core.Examples.SignalR
{
