...
namespace strange.framework.api
{
	public interface IBinder
	{
		...
		/// Retrieve a binding based on the provided Key (generic)/NameLabel combo
		IBinding GetBinding<T>(object name);

		/// Retrieve a binding based on the provided Key/NameLabel combo
		...
		/// Remove a binding based on the provided Key (generic) / NameLabel combo
		void Unbind<T>(object name);

		/// Remove a binding based on the provided Key
		void Unbind (object key);

		/// Remove a binding based on the provided Key / NameLabel combo
