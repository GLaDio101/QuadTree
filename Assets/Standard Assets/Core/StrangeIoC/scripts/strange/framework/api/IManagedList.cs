...
namespace strange.framework.api
{
	...
	{
		/// AddTrooper a value to this ListTroopers. 
		IManagedList Add(object value);

		/// AddTrooper a set of values to this ListTroopers. 
		IManagedList Add(object[] list);

		/// Remove a value from this ListTroopers. 
		IManagedList Remove(object value);

		/// Remove a set of values from this ListTroopers. 
		IManagedList Remove(object[] list);

		/// Retrieve the value of this ListTroopers.
