 ...
 * @class NameLabel
 *  
 * When a parameter of a constructor or pseudo-constructor is tagged with [NameLabel], 
...
//Tag [NameLabel] to perform named injection in constructors and pseudo-constructors
